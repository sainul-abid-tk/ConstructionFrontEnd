  ...
  return (
    ...
    <Header />
      ...
      <div className='flex flex-col justify-center items-centers max-[575px]:p-5'>
          ...
          <Link className='' to={'/workers'}>
          <Button style={{fontSize:'14.4px',background:'rgb(250 204 21 / var(--tw-bg-opacity))',color:'black',fontWeight:'bold'}} className='bg-yellow-300' variant="contained" endIcon={<ForwardIcon className="hover:scale-x-125" style={{fontSize:'30px'}} />}>Discover Available Talent</Button>
          </Link>
          </div>
        </div>
